...
assert.doesNotMatch(cloudSource, /setTimeout\(installOwnerConfirmedRecoveryButton|restore\.onclick=chooseConfirmedSchedulerRecoveryFile/, 'completed one-time recovery controls are no longer callable');
