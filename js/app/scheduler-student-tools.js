(function(){
  ...
  window.saveQuickStudent=function(){
    ...
    const student=studentDefaults({id:uid(),name,parent:'',contact:'',homeAddress:'',courseType:$('quickCourseType').value,preferredTeacherId:$('v20QuickTeacher')?.value||'',branchIds:branch?[branch]:[],attendanceBranchId:branch,billingBranchId:$('quickBillingBranch')?.value||'',status:'active'});
