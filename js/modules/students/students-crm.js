...
function studentTeacherIds(s){const ids=new Set();(db.lessons||[]).filter(l=>!l.isDraft&&String(l.studentId)===String(s.id)).forEach(l=>lessonTeacherIds(l).forEach(id=>ids.add(String(id))));return ids}
