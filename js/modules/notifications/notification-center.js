...
(function(){
 ...
 function buildNotifications(){
  ...
  const authorizedItems=c.role==='branch_manager'&&c.hideFinancials===true?items.filter(x=>x.category!=='payment'&&x.action?.type!=='settlement'&&x.action?.type!=='collections'):items;
