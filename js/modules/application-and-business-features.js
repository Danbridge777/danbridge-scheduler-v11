...
function handleLessonStudentChange(){if($('lessonDeliveryMode')?.value==='home'){const addr=student($('lessonStudent')?.value||'').homeAddress||'';if(addr&&!$('lessonAddress').value.trim())$('lessonAddress').value=addr}handleLocationChange();syncCoTeacherOptions();syncCampField()}
