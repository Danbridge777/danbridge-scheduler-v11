...
const recordId=value=>typeof value==='string'&&value.trim()===value&&value.length>0&&!hasUnpairedSurrogate(value)&&new TextEncoder().encode(value).length<=1500&&!/[\u0000-\u001f\u007f/]/.test(value)&&value!=='.'&&value!=='..'&&!/^__.*__$/.test(value);
