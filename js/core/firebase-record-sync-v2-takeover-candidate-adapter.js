...
function valueOf(snapshot){if(snapshot==null)return null;if(typeof snapshot.exists==='function'){if(!snapshot.exists())return null;return snapshot.data()}return snapshot}
