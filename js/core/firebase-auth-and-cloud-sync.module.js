...
import {bootstrapDanbridgeFirebase} from './firebase-environment-bootstrap.js?v=20.26.313';
import {createScheduleNotificationPresenter} from './schedule-notification-presentation.js?v=20.26.313';
import {createShardedSnapshot,assembleShardedSnapshot,canRunStagingShadow} from './cloud-sharded-store.js?v=20.26.313';
import {createFirebaseRecordShadowAdapter} from './firebase-record-shadow-adapter.js?v=20.26.313';
import {createFirebaseFullRecordShadowAdapter} from './firebase-full-record-shadow-adapter.js?v=20.26.313';
import {buildRecordShadowRunManifest,verifyRecordShadowRun,buildRecordShadowActivation,canonicalRecordShadowCore,canonicalLegacyRecordShadowCore,extractFullRecordShadowSyncResult,buildFullRecordShadowRunIdentity} from './cloud-record-shadow-run.js?v=20.26.313';
import {evaluateRecordShadowReadCandidate} from './cloud-record-shadow-read-candidate.js?v=20.26.313';
import {prepareImmutableMigrationBackup,verifyImmutableMigrationBackupReadback,sealImmutableMigrationBackup,verifyImmutableMigrationBackupManifest,sha256Canonical} from './cloud-immutable-migration-backup.js?v=20.26.313';
import {createFirebaseRoleViewCandidateAdapter} from './firebase-role-view-candidate-adapter.js?v=20.26.313';
import {verifyOwnRoleViewCandidateReadback} from './cloud-role-view-candidate.js?v=20.26.313';
import {buildFullRecordCandidateManifest,buildRoleViewCandidateManifest as buildLegacyRoleViewCandidateManifest,buildAtomicRecordActivation,evaluateAtomicRecordActivation} from './cloud-record-activation.js?v=20.26.313';
import {decideRecordReadTakeover} from './cloud-record-read-takeover.js?v=20.26.313';
import {FULL_RECORD_COLLECTIONS,rebuildFullRecordShadowDb} from './cloud-full-record-shadow.js?v=20.26.313';
import {recordDataDigest,recordDataHash} from './cloud-record-data-hash.js?v=20.26.313';
import {buildStagingLivePreflight} from './cloud-staging-live-preflight.js?v=20.26.313';
import {createBrowserOperationJournalStorage} from './browser-operation-journal-storage.js?v=20.26.313';
import {createOwnerDraftStore} from './cloud-owner-draft-store.js?v=20.26.313';
import {createProductionSchedulerQueue,acquireProductionSchedulerLease} from './production-scheduler-queue.js?v=20.26.313';
import {createBrowserStagingLiveExecutionStorage} from './browser-staging-live-execution-storage.js?v=20.26.313';
import {createOperationJournal} from './cloud-operation-journal.js?v=20.26.313';
import {enqueueOperationPlan,runOperationWorker} from './cloud-operation-worker.js?v=20.26.313';
import {createFirebaseLiveRecordOperationAdapter} from './firebase-live-record-operation-adapter.js?v=20.26.313';
import {assertStagingExecutionManifestEnvelope,stripStagingExecutionManifestAudit,verifyStagingLiveJournalRows} from './cloud-staging-live-activation.js?v=20.26.313';
import {createFirebaseStagingLiveActivationAdapter} from './firebase-staging-live-activation-adapter.js?v=20.26.313';
import {createActiveRecordPageController} from './cloud-active-record-page-controller.js?v=20.26.313';
import {createFirebaseActiveRecordStreamAdapter} from './firebase-active-record-stream-adapter.js?v=20.26.313';
import {createFirebaseRoleRecordViewAdapter} from './firebase-role-record-view-adapter.js?v=20.26.313';
import {createFirebaseRoleRecordStreamAdapter} from './firebase-role-record-stream-adapter.js?v=20.26.313';
import {createActiveRoleRecordPublishQueue} from './cloud-active-role-record-publish-queue.js?v=20.26.313';
import {decideOwnerActiveSaveIntent} from './cloud-owner-active-save-intent.js?v=20.26.313';
import {createRecordSyncActiveFailureResume} from './record-sync-active-failure-resume.js?v=20.26.313';
import {dailyBackupChunkCore,prepareDailyShardedBackup,sealDailyShardedBackup,verifyDailyShardedBackupReadback} from './cloud-daily-sharded-backup.js?v=20.26.313';
import {createFirebaseRecordSyncCandidateAdapter} from './firebase-record-sync-candidate-adapter.js?v=20.26.313';
import {buildRecordSyncRoleEvidence,RECORD_SYNC_ROLE_SCENARIOS} from './cloud-record-sync-role-evidence.js?v=20.26.313';
import {buildRecordSyncActivationManifest,buildActiveRecordSyncControl,evaluateActiveRecordSyncControl} from './cloud-record-sync-control.js?v=20.26.313';
import {createFirebaseRecordSyncActivationAdapter} from './firebase-record-sync-activation-adapter.js?v=20.26.313';
...
import {loadProfileAfterAuthReady} from './cloud-auth-profile-bootstrap.js?v=20.26.313';
import {RECORD_SYNC_V2_TAKEOVER_CANDIDATE_CONTROL_PATH,RECORD_SYNC_V2_TAKEOVER_CANDIDATE_HEAD_PATH,createFirebaseRecordSyncV2TakeoverCandidateAdapter} from './firebase-record-sync-v2-takeover-candidate-adapter.js?v=20.26.313';
import {createStagingV2AuthorityReadLoader} from './staging-v2-authority-read-loader.js?v=20.26.313';
import {createStagingV2AuthoritySaveBrowserClient} from './staging-v2-authority-save-browser-client.js?v=20.26.313';
import {createStagingV2ActiveRecordOperationSender,normalizeStagingV2FirestoreValue,stagingV2H0GenesisBaselineDocuments} from './staging-v2-active-record-browser-bridge.js?v=20.26.313';
import {createFirebaseProductionRecordConflictAdapter,createFirebaseProductionRecordStreamAdapter} from './firebase-production-record-runtime-adapter.js?v=20.26.313';
import {buildProductionRecordRuntimeControl,assertProductionRecordRuntimeControl,buildProductionRecordRuntimeSafety,assertProductionRecordRuntimeSafety,assertLegacyProductionRecordRuntimeSafety} from './cloud-production-record-runtime.js?v=20.26.313';
import {CLOUD_BOOTSTRAP_STAGES,createCloudBootstrapProgress} from './cloud-bootstrap-progress.js?v=20.26.313';
import {createProductionTrustedOperationClient} from './production-trusted-operation-client.js?v=20.26.313';
import {prepareActiveRecordSync} from './cloud-active-record-sync.js?v=20.26.313';
import {createFirebaseCallableHttpClient} from './firebase-callable-http-client.js?v=20.26.313';
import {createLimitedUseAppCheckTokenPool,takeFreshLimitedUseAppCheckToken} from './app-check-limited-use-token.js?v=20.26.313';
import {createPublishedRoleViewConsumer} from './published-role-view-consumer.js?v=20.26.313';
import {createFirestoreRolePartBatchReader} from './firestore-role-part-batch-reader.js?v=20.26.313';
import {createPublishedSchedulerReceiptReader,PUBLISHED_SCHEDULER_RESPONSE_SCHEMA} from './published-scheduler-receipt.js?v=20.26.313';
