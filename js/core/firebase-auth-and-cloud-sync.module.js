...
import {bootstrapDanbridgeFirebase} from './firebase-environment-bootstrap.js?v=20.26.210';
import {createScheduleNotificationPresenter} from './schedule-notification-presentation.js?v=20.26.210';
import {createShardedSnapshot,assembleShardedSnapshot,canRunStagingShadow} from './cloud-sharded-store.js?v=20.26.210';
import {createFirebaseRecordShadowAdapter} from './firebase-record-shadow-adapter.js?v=20.26.210';
import {createFirebaseFullRecordShadowAdapter} from './firebase-full-record-shadow-adapter.js?v=20.26.210';
import {buildRecordShadowRunManifest,verifyRecordShadowRun,buildRecordShadowActivation,canonicalRecordShadowCore,canonicalLegacyRecordShadowCore,extractFullRecordShadowSyncResult,buildFullRecordShadowRunIdentity} from './cloud-record-shadow-run.js?v=20.26.210';
import {evaluateRecordShadowReadCandidate} from './cloud-record-shadow-read-candidate.js?v=20.26.210';
import {prepareImmutableMigrationBackup,verifyImmutableMigrationBackupReadback,sealImmutableMigrationBackup,verifyImmutableMigrationBackupManifest,sha256Canonical} from './cloud-immutable-migration-backup.js?v=20.26.210';
import {createFirebaseRoleViewCandidateAdapter} from './firebase-role-view-candidate-adapter.js?v=20.26.210';
import {verifyOwnRoleViewCandidateReadback} from './cloud-role-view-candidate.js?v=20.26.210';
import {buildFullRecordCandidateManifest,buildRoleViewCandidateManifest as buildLegacyRoleViewCandidateManifest,buildAtomicRecordActivation,evaluateAtomicRecordActivation} from './cloud-record-activation.js?v=20.26.210';
import {decideRecordReadTakeover} from './cloud-record-read-takeover.js?v=20.26.210';
import {FULL_RECORD_COLLECTIONS,rebuildFullRecordShadowDb} from './cloud-full-record-shadow.js?v=20.26.210';
import {recordDataDigest,recordDataHash} from './cloud-record-data-hash.js?v=20.26.210';
import {buildStagingLivePreflight} from './cloud-staging-live-preflight.js?v=20.26.210';
import {createBrowserOperationJournalStorage} from './browser-operation-journal-storage.js?v=20.26.210';
import {createProductionSchedulerQueue,acquireProductionSchedulerLease} from './production-scheduler-queue.js?v=20.26.210';
import {createBrowserStagingLiveExecutionStorage} from './browser-staging-live-execution-storage.js?v=20.26.210';
import {createOperationJournal} from './cloud-operation-journal.js?v=20.26.210';
import {enqueueOperationPlan,runOperationWorker} from './cloud-operation-worker.js?v=20.26.210';
import {createFirebaseLiveRecordOperationAdapter} from './firebase-live-record-operation-adapter.js?v=20.26.210';
import {assertStagingExecutionManifestEnvelope,stripStagingExecutionManifestAudit,verifyStagingLiveJournalRows} from './cloud-staging-live-activation.js?v=20.26.210';
import {createFirebaseStagingLiveActivationAdapter} from './firebase-staging-live-activation-adapter.js?v=20.26.210';
import {createActiveRecordPageController} from './cloud-active-record-page-controller.js?v=20.26.210';
import {createFirebaseActiveRecordStreamAdapter} from './firebase-active-record-stream-adapter.js?v=20.26.210';
import {createFirebaseRoleRecordViewAdapter} from './firebase-role-record-view-adapter.js?v=20.26.210';
import {createFirebaseRoleRecordStreamAdapter} from './firebase-role-record-stream-adapter.js?v=20.26.210';
import {createActiveRoleRecordPublishQueue} from './cloud-active-role-record-publish-queue.js?v=20.26.210';
import {decideOwnerActiveSaveIntent} from './cloud-owner-active-save-intent.js?v=20.26.210';
import {createRecordSyncActiveFailureResume} from './record-sync-active-failure-resume.js?v=20.26.210';
import {dailyBackupChunkCore,prepareDailyShardedBackup,sealDailyShardedBackup,verifyDailyShardedBackupReadback} from './cloud-daily-sharded-backup.js?v=20.26.210';
import {createFirebaseRecordSyncCandidateAdapter} from './firebase-record-sync-candidate-adapter.js?v=20.26.210';
import {buildRecordSyncRoleEvidence,RECORD_SYNC_ROLE_SCENARIOS} from './cloud-record-sync-role-evidence.js?v=20.26.210';
import {buildRecordSyncActivationManifest,buildActiveRecordSyncControl,evaluateActiveRecordSyncControl} from './cloud-record-sync-control.js?v=20.26.210';
import {createFirebaseRecordSyncActivationAdapter} from './firebase-record-sync-activation-adapter.js?v=20.26.210';
...
import {loadProfileAfterAuthReady} from './cloud-auth-profile-bootstrap.js?v=20.26.210';
import {RECORD_SYNC_V2_TAKEOVER_CANDIDATE_CONTROL_PATH,RECORD_SYNC_V2_TAKEOVER_CANDIDATE_HEAD_PATH,createFirebaseRecordSyncV2TakeoverCandidateAdapter} from './firebase-record-sync-v2-takeover-candidate-adapter.js?v=20.26.210';
import {createStagingV2AuthorityReadLoader} from './staging-v2-authority-read-loader.js?v=20.26.210';
import {createStagingV2AuthoritySaveBrowserClient} from './staging-v2-authority-save-browser-client.js?v=20.26.210';
import {createStagingV2ActiveRecordOperationSender,normalizeStagingV2FirestoreValue,stagingV2H0GenesisBaselineDocuments} from './staging-v2-active-record-browser-bridge.js?v=20.26.210';
import {createFirebaseProductionRecordConflictAdapter,createFirebaseProductionRecordStreamAdapter} from './firebase-production-record-runtime-adapter.js?v=20.26.210';
import {buildProductionRecordRuntimeControl,assertProductionRecordRuntimeControl,buildProductionRecordRuntimeSafety,assertProductionRecordRuntimeSafety,assertLegacyProductionRecordRuntimeSafety} from './cloud-production-record-runtime.js?v=20.26.210';
import {CLOUD_BOOTSTRAP_STAGES,createCloudBootstrapProgress} from './cloud-bootstrap-progress.js?v=20.26.210';
import {createProductionTrustedOperationClient} from './production-trusted-operation-client.js?v=20.26.210';
import {prepareActiveRecordSync} from './cloud-active-record-sync.js?v=20.26.210';
