import {buildLiveOperationPlan} from './cloud-live-operation-plan.js?v=20.26.92';
...
export function buildStagingLivePreflight({environment,role,projectId,sourceState,targetDb,backup,restoreReceipt,legacyVersionHash,deviceId,startSequence=1,readBudget,writeBudget,createdAt,maxOperationsPerRun=100}={}){
 ...
 const manifest=buildStagingExecutionManifest({plan,sourceDb:sourceState.db,sourceRevisions:sourceState.revisions,targetDb,backup,restoreReceipt,legacyVersionHash,readBudget,writeBudget,createdAt,maxOperationsPerRun});
