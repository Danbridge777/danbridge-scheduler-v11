...
test('cutover only changes verified safety controls and preserves complete authority identity',()=>{
 ...
 const original={...body,lastEventHash:sha256Canonical(body)},paused=transitionSafety(original,'pause','2026-09-12T01:00:00.000Z'),resumed=transitionSafety(paused,'resume','2026-09-12T02:00:00.000Z');
