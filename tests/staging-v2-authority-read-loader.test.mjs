...
const auditPath=`stagingActiveRecordV2AuditAppends/danbridge/epochs/${epoch}/records`;
...
function fixture(){
 const calls=[],docs=new Map([[manifestPath,{invalid:'manifest'}],[headPath,{invalid:'head'}]]),collections=new Map([[ledgersPath,[]],[auditPath,[]],...FULL_RECORD_COLLECTIONS.flatMap(collection=>[[baselinePath(collection),[]],[dailyPath(collection),[]]])]);
