...
const run={schema:'danbridge-record-shadow-run-v2',environment:'staging',state:'verified',runId:'run-2',sourceHash:'full-hash',verifiedHash:'full-hash',coreHash,documentCount:4,activeCount:3,tombstoneCount:1};
const activation={schema:'danbridge-record-shadow-activation-v2',environment:'staging',activeRunId:'run-2',sourceHash:'full-hash',verifiedHash:'full-hash',coreHash,documentCount:4,activeCount:3,tombstoneCount:1};
...
test('run identity、整份來源 hash、控制 coreHash 或實際核心內容 hash 不符全部拒絕',()=>{
 ...
 assert.match(evaluate({readback:{...readback,db:{...db,lessons:[]}}}).reason,/coreHash/);
});
