...
const fakeG3=()=>({state:'complete-confirmed',transactionState:'replayed',scope:'native-fixed-genesis-authority-replay-capability-for-future-v2-reservation-registration-only',environment:'staging',companyId:'danbridge',projectId:'danbridge-rules-test',sourceV1ActivationEpoch:'active-epoch-12345',sourceFreezeId:'freeze-12345678',targetV2Epoch:'v2-epoch-12345678',seedId:'v2-genesis:'+'1'.repeat(64),parentFrozenSourceProofHash:'2'.repeat(64),seedManifestHash:'3'.repeat(64),identityIndexRootHash:'a'.repeat(64),identityIndexRootAuditHash:'b'.repeat(64),identityIndexRootPersistedAt:'2026-08-17T03:23:59.123456789Z',durableManifestHash:'4'.repeat(64),readbackReceiptHash:'5'.repeat(64),authorityHash:'6'.repeat(64),authorityAuditHash:'7'.repeat(64),persistedAt:'2026-08-17T03:24:00.123456789Z',writeCount:0});
