...
test('後端完整回條驗證後先顯示雲端確認，IndexedDB 收尾仍保持永久日誌',async()=>{
 ...
 const q=createProductionSchedulerQueue({storage,release:'20.26.224',createRequestId:()=>`confirmed-boundary-request`,onState:event=>states.push(event.state),send:async request=>{
