...
const audited=(core,overrides={})=>({...core,persistedAt:'2026-08-18T01:02:03.123456789Z',persistedBy:'service-account:danbridge-staging-v2',persistedByEmail:'danbridge-staging-v2@danbridge-d8877-staging.iam.gserviceaccount.com',...overrides});
