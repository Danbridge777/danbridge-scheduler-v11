...
test('保留目前 30 筆安全上限，拒絕超限、重複 ID 或費用欄位注入',()=>{
 ...
 const request={schema:SCHEDULER_OPERATION_SCHEMA,requestId:'batch-boundary-test',release:'20.26.262',changes};assert.equal(normalizeProductionSchedulerRequest(request).changes.length,30);
